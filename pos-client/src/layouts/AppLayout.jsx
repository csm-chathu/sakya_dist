...
export default function AppLayout() {
  ...
  const mainNav = [
    ...
    { to: '/sales',           label: 'Orders',             icon: Icons.sales,     feature: 'sales', hideFor: ['cashier'] },
    ...
    { to: '/invoices',        label: 'Day End',            icon: Icons.sales,     feature: 'invoices' },
  ...
  ].filter(n => canSee(n.feature) && !(n.hideFor?.includes(role)));
